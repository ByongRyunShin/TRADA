...
public class SNSActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout linearLayout = (LinearLayout)findViewById(R.id.SNS_LinearLayout);

        SubSNS cardview = new SubSNS(getApplicationContext());
        // name.setText(datastr[0][0]);
        linearLayout.addView(cardview);

        SubSNS cardview2 = new SubSNS(getApplicationContext());
        SubSNS cardview3 = new SubSNS(getApplicationContext());
        SubSNS cardview4 = new SubSNS(getApplicationContext());
